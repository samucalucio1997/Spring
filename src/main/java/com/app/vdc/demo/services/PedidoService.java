...
public class PedidoService implements PedidoIS {
	...
	public String FinalizarPedido(Carrinho car) {
		float Total = 0.0F;
		if (!car.getProdutos().isEmpty()) {// pegar o id do carrinho "car" no banco de
											// dados use a dependencia
		...
		return "Pedido do Cliente " + " foi finalizada com sucesso." + " Total da compra: R$" + Total;
	}
